  ...
  return (
    <footer className="relative pt-20 pb-10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="flex flex-wrap gap-3">
              {personalInfo.socials.map((social) => (
                <a
                  ...
                  className="w-12 h-12 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700 hover:border-emerald-500 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-cyan-500 hover:scale-110 hover:-translate-y-1 group"
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-slate-800/50 gap-4 animate-fadeIn">
          ...
          <button
            onClick={scrollToTop}
            className="group relative w-12 h-12 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-xl flex items-center justify-center text-white transition-all duration-300 shadow-lg shadow-emerald-500/20 hover:shadow-xl hover:shadow-emerald-500/40 hover:scale-110 hover:-translate-y-1 active:scale-95"
            aria-label="Scroll to top"
          >
            <ArrowUp size={20} className="group-hover:-translate-y-1 transition-transform duration-300" />
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-emerald-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          </button>
        </div>
      </div>
    </footer>
